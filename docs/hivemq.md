...
HiveMQ, e-posta adresinize gönderilen doğrulama mesajını onaylamanızı ister. E-posta adresinize gelen mesaja tıklayın.  
...
Ad, soyad, iş ünvanı (job title) ve şirket (company) bilgilerinizi girerek **Continue** butonuna basın.  
...
Cluster oluşturulduktan sonra “Your Clusters” ekranında **Manage Cluster** butonu görünür. **Manage Cluster** butona basın. 
...
Bağlantı başarılı olduğunda WebClient “Connected” yazar. Ekranın sağ bölümünde **Messages** kısmındaki **Subscribe to all messages** seçeneğini aktif edin.  
